 ...
 * Date 2020/11/19
 */
public class ObserveDesiredDeltaMethodTest {
    ...
    public void testObserveSuccess(@Mocked IAvatarTransport avatarTransport) {
        ...
        ObserveDesiredDeltaMethod method =
                new ObserveDesiredDeltaMethod(avatarId.getDeviceSideEntityId(), avatarId, avatarTransport);
