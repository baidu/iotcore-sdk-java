...
public class InProcessMessageQueue {
    ...
    private static final int EXPIRATION_ROUNDS_NUM = 10;
    ...
    public InProcessMessageQueue(String iotCoreId, int capacity, long expireTimeInMs) {
        ...
        for (int i = 0; i < EXPIRATION_ROUNDS_NUM; i++) {
            this.expirationRounds.add(new LinkedBlockingQueue<>());
        }

        checkExpirationTask = Observable.interval(expireTimeInMs / EXPIRATION_ROUNDS_NUM,
    ...
    public abstract static class InProcessMessageCallBack {
