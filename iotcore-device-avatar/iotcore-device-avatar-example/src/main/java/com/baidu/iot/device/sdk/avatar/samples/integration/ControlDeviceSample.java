...
public class ControlDeviceSample {
    ...
    public static void main(String[] args) {
        ...
        PropertyKey desiredKey = new PropertyKey("test");
        ...
        device.observeDesired(desiredKey)
        ...
        for (int i = 0; i < testTimeInSec / reportIntervalInSec; i++) {
            ...
            PropertyValue desiredValue = new PropertyValue(String.valueOf(i));
            properties.put(desiredKey, desiredValue);
            controlledDevice.updateDesired(properties).blockingSubscribe(new DisposableSingleObserver<Status>() {
                @Override
                public void onSuccess(@NonNull Status status) {
                    System.out.println("Update desired using " + desiredValue + " success, status:" + status);
                }
